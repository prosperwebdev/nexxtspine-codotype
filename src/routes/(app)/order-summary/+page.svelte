...
<Card class="w-full max-w-full rounded-none">
  <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16 rounded-xl">
    <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="mx-auto max-w-3xl">
        ...
        <div class="mt-6 space-y-4 border-b border-t border-gray-200 py-8 dark:border-gray-700 sm:mt-8">
          <h2 class="text-lg text-gray-900 dark:text-white sm:text-2xl">Order Summary</h2>
          <Card class="flex flex-col gap-4">
            <dl>
              <dt class="text-base font-small text-gray-900 dark:text-white">Surgeon</dt>
              <dd class="text-base font-normal text-gray-500 dark:text-gray-400">Bonnie Green, MD</dd>
            </dl>
            <dl>
              <dt class="text-base font-small text-gray-900 dark:text-white">Hospital</dt>
              <dd class="text-base font-normal text-gray-500 dark:text-gray-400">Maine Medical Center, Portland, ME 04101</dd>
            </dl>
            <dl>
              <dt class="text-base font-small text-gray-900 dark:text-white">Surgery Date</dt>
              <dd class="text-base font-normal text-gray-500 dark:text-gray-400">11/25/2024</dd>
            </dl>
          </Card>
        </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-5">
            <div class="flex items-center gap-4 sm:col-span-2">
              <div class="flex items-center">
                ...
                <label for="company_address_billing_modal" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                  Order as a company
                </label>
              </div>
            </div>
